...
| Product | Score | Keep? |
|---|---|---|
| Proactive Sourcing | +55 | ✅ primary, own solution page, 3 audiences |
| Inbound Deal Parsing | +55 | ✅ primary, 2 solution pages, 2 audiences |
| Universal Enrichment Pipeline | +50 | ✅ primary, own solution page, 3 audiences |
| Web Platform | +15 | ❌ below threshold; UI wrapper, homepage-only refs |
| CRM Integrations | −25 | ❌ "CRM" channel penalty |
| REST API v1 | −35 | ❌ "API/REST" channel penalty |
| Chrome Extension | −40 | ❌ "Extension" channel penalty |
| Bulk Data | −65 | ❌ "Bulk" + services category + homepage-only |
