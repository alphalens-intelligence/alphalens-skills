...
<nav id="site-nav">
  ...
  <div class="sn-links">
    <a class="sn-link [sn-active?]" href="{anchor}-market-map.html">
      <!-- grid icon --> Market Map
    </a>
    <a class="sn-link [sn-active?]" href="{anchor}-investor-network.html">
      <!-- network icon --> Investor Network
    </a>
    <a class="sn-link [sn-active?]" href="{anchor}-peer-benchmark.html">
      <!-- bar chart icon --> Peer Benchmark
    </a>
  </div>
